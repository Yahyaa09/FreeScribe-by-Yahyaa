...
export default function HomePage(props) {
    const { setAudioStream, setFile, Setddu, ddu } = props;
    ...
    return (
        <main className='flex-1 p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 relative'>
                ...
                <label className='text-blue-400 cursor-pointer hover:text-blue-600 duration-200'>
                    ...
                    <input
                        onChange={(e) => {
                            ...
                            const audio = new Audio(URL.createObjectURL(tempFile));

                            audio.onloadedmetadata = () => {
                                const fileDuration = Math.floor(audio.duration);
                                Setddu(fileDuration); // Set the duration for the uploaded file
                            };
                        }}
                        className='hidden'
                        type='file'
